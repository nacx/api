...
// Almost a copy from istio repo except for the change 'web-ui'
package main
...
var (
	...
	// some fields naming is not a valid field name in proto but used in values.yaml, eg. web-ui.
	...
	for _, l := range tmp {
		...
		for k, v := range subs {
			if strings.Contains(l, k) {
				...
				// Remove any autogenerated functions for the sythetic types.
