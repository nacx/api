...
import (
	...
	v1 "github.com/tetrateio/tetrate/api/audit/v1"
...
func (m *ListServiceAuditLogsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListServiceAuditLogsRequest.Merge(m, src)
}
