...
package workflows // import "github.com/tetrateio/tetrate/api/tcc/v1/workflows"
...
func (ListPendingResponse_PendingRequest_OP) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{4, 0, 0}
}
...
func (*LoadBalancerWorkflowUserRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{0}
}
...
func (*Status) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{1}
}
...
func (*GetStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{2}
}
...
func (*ListRequests) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{3}
}
...
func (*ListPendingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{4}
}
...
type ListPendingResponse_PendingRequest struct {
	Loadbalancer         string                                `protobuf:"bytes,1,opt,name=loadbalancer,proto3" json:"loadbalancer,omitempty"`
	Service              string                                `protobuf:"bytes,2,opt,name=service,proto3" json:"service,omitempty"`
	Operation            ListPendingResponse_PendingRequest_OP `protobuf:"varint,3,opt,name=operation,proto3,enum=tetrate.api.tcc.v1.workflows.ListPendingResponse_PendingRequest_OP" json:"operation,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                              `json:"-"`
	XXX_unrecognized     []byte                                `json:"-"`
	XXX_sizecache        int32                                 `json:"-"`
}
...
func (*ListPendingResponse_PendingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{4, 0}
}
...
func (*ApproveRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{5}
}
...
func (*DenyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{6}
}
...
func (*CancelRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{7}
}
...
func (*ApproveResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{8}
}
...
func (*DenyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{9}
}
...
func (*CancelResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{10}
}
...
func (*LoadBalancerWorkflowOwnerRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{11}
}
...
func (*TLSSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_loadbalancer_bbf130600be1ef63, []int{12}
}
...
func init() {
	proto.RegisterType((*LoadBalancerWorkflowUserRequest)(nil), "tetrate.api.tcc.v1.workflows.LoadBalancerWorkflowUserRequest")
	proto.RegisterType((*Status)(nil), "tetrate.api.tcc.v1.workflows.Status")
	proto.RegisterType((*GetStatus)(nil), "tetrate.api.tcc.v1.workflows.GetStatus")
	proto.RegisterType((*ListRequests)(nil), "tetrate.api.tcc.v1.workflows.ListRequests")
	proto.RegisterType((*ListPendingResponse)(nil), "tetrate.api.tcc.v1.workflows.ListPendingResponse")
	proto.RegisterType((*ListPendingResponse_PendingRequest)(nil), "tetrate.api.tcc.v1.workflows.ListPendingResponse.PendingRequest")
	proto.RegisterType((*ApproveRequest)(nil), "tetrate.api.tcc.v1.workflows.ApproveRequest")
	proto.RegisterType((*DenyRequest)(nil), "tetrate.api.tcc.v1.workflows.DenyRequest")
	proto.RegisterType((*CancelRequest)(nil), "tetrate.api.tcc.v1.workflows.CancelRequest")
	proto.RegisterType((*ApproveResponse)(nil), "tetrate.api.tcc.v1.workflows.ApproveResponse")
	proto.RegisterType((*DenyResponse)(nil), "tetrate.api.tcc.v1.workflows.DenyResponse")
	proto.RegisterType((*CancelResponse)(nil), "tetrate.api.tcc.v1.workflows.CancelResponse")
	proto.RegisterType((*LoadBalancerWorkflowOwnerRequest)(nil), "tetrate.api.tcc.v1.workflows.LoadBalancerWorkflowOwnerRequest")
	proto.RegisterType((*TLSSettings)(nil), "tetrate.api.tcc.v1.workflows.TLSSettings")
	proto.RegisterEnum("tetrate.api.tcc.v1.workflows.ListPendingResponse_PendingRequest_OP", ListPendingResponse_PendingRequest_OP_name, ListPendingResponse_PendingRequest_OP_value)
}
...
func (c *loadBalancerWorkflowClient) Attach(ctx context.Context, in *LoadBalancerWorkflowUserRequest, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/Attach", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loadBalancerWorkflowClient) Detach(ctx context.Context, in *LoadBalancerWorkflowUserRequest, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/Detach", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loadBalancerWorkflowClient) Publish(ctx context.Context, in *LoadBalancerWorkflowOwnerRequest, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loadBalancerWorkflowClient) ListPendingRequests(ctx context.Context, in *ListRequests, opts ...grpc.CallOption) (*ListPendingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/ListPendingRequests", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loadBalancerWorkflowClient) GetRequestStatus(ctx context.Context, in *GetStatus, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/GetRequestStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loadBalancerWorkflowClient) Approve(ctx context.Context, in *ApproveRequest, opts ...grpc.CallOption) (*ApproveResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/Approve", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loadBalancerWorkflowClient) Deny(ctx context.Context, in *DenyRequest, opts ...grpc.CallOption) (*DenyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/Deny", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loadBalancerWorkflowClient) Cancel(ctx context.Context, in *CancelRequest, opts ...grpc.CallOption) (*CancelResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/Cancel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LoadBalancerWorkflow_Attach_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/Attach",
	}
...
func _LoadBalancerWorkflow_Detach_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/Detach",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LoadBalancerWorkflow_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/Publish",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LoadBalancerWorkflow_ListPendingRequests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/ListPendingRequests",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LoadBalancerWorkflow_GetRequestStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/GetRequestStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LoadBalancerWorkflow_Approve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/Approve",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LoadBalancerWorkflow_Deny_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/Deny",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LoadBalancerWorkflow_Cancel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow/Cancel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _LoadBalancerWorkflow_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tetrate.api.tcc.v1.workflows.LoadBalancerWorkflow",
...
func init() { proto.RegisterFile("loadbalancer.proto", fileDescriptor_loadbalancer_bbf130600be1ef63) }

var fileDescriptor_loadbalancer_bbf130600be1ef63 = []byte{
	...
	0x31, 0x67, 0x1d, 0xf3, 0x9a, 0x87, 0x97, 0xaf, 0x26, 0xfc, 0x5a, 0x34, 0x9a, 0x63, 0xce, 0xc7,
	0x13, 0xb4, 0x58, 0xe0, 0x59, 0xcc, 0xf7, 0xb9, 0x64, 0xd2, 0xe3, 0xbe, 0x88, 0xf7, 0xd2, 0x21,
	0x3c, 0x3c, 0xe1, 0xcc, 0x3d, 0xd2, 0x8a, 0x5f, 0xeb, 0x6d, 0x5f, 0x09, 0x0c, 0x6d, 0xfc, 0x76,
	...
	,
}
