...
// Validate checks the field values on TeamPolicyRequest with the rules defined
// in the proto definition for this message. If any rules are violated, an
// error is returned.
func (m *TeamPolicyRequest) Validate() error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetTenant()) < 1 {
		return TeamPolicyRequestValidationError{
			field:  "Tenant",
			reason: "value length must be at least 1 runes",
		}
	}
...
// TeamPolicyRequestValidationError is the validation error returned by
// TeamPolicyRequest.Validate if the designated constraints aren't met.
type TeamPolicyRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e TeamPolicyRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e TeamPolicyRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e TeamPolicyRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e TeamPolicyRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e TeamPolicyRequestValidationError) ErrorName() string {
	return "TeamPolicyRequestValidationError"
}

// Error satisfies the builtin error interface
func (e TeamPolicyRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sTeamPolicyRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = TeamPolicyRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = TeamPolicyRequestValidationError{}
...
// Validate checks the field values on UserPolicyRequest with the rules defined
// in the proto definition for this message. If any rules are violated, an
// error is returned.
func (m *UserPolicyRequest) Validate() error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetTenant()) < 1 {
		return UserPolicyRequestValidationError{
			field:  "Tenant",
			reason: "value length must be at least 1 runes",
		}
	}
...
// UserPolicyRequestValidationError is the validation error returned by
// UserPolicyRequest.Validate if the designated constraints aren't met.
type UserPolicyRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UserPolicyRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UserPolicyRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UserPolicyRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UserPolicyRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UserPolicyRequestValidationError) ErrorName() string {
	return "UserPolicyRequestValidationError"
}

// Error satisfies the builtin error interface
func (e UserPolicyRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUserPolicyRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UserPolicyRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UserPolicyRequestValidationError{}
