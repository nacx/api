 ...
 * 
 * @export
 * @interface TetrateApiTccV1CreateEndpointRequest
 */
export interface TetrateApiTccV1CreateEndpointRequest {
    /**
     * 
     * @type {string}
     * @memberof TetrateApiTccV1CreateEndpointRequest
     */
    name?: string;
    /**
     * 
...
export function TetrateApiTccV1CreateEndpointRequestFromJSON(json: any): TetrateApiTccV1CreateEndpointRequest {
    return {
...
export function TetrateApiTccV1CreateEndpointRequestToJSON(value?: TetrateApiTccV1CreateEndpointRequest): any {
    if (value === undefined) {
        return undefined;
    }
    return {
