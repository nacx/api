...
func (m *ConfigureGatewayRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConfigureGatewayRequest.Merge(m, src)
}
...
func (m *ActivateGatewayConfigurationRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ActivateGatewayConfigurationRequest.Merge(m, src)
}
...
func (*ApplyRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
...
func (*ApplyRequest_Binding) Descriptor() ([]byte, []int) {
	return fileDescriptor_413a91106d7bcce8, []int{6, 0}
}
...
func (m *ApplyRequest_Binding) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ApplyRequest_Binding.Merge(m, src)
}
...
func (m *GatewayConfigurationEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GatewayConfigurationEntry.Merge(m, src)
}
...
func (m *GatewayEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GatewayEntry.Merge(m, src)
}
...
func (m *VirtualServiceEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VirtualServiceEntry.Merge(m, src)
}
