...
func (m *ListIngressGatewaysRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListIngressGatewaysRequest.Merge(m, src)
}
...
func (m *ListIngressGatewaysResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListIngressGatewaysResponse.Merge(m, src)
}
...
func (m *GetIngressGatewayRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetIngressGatewayRequest.Merge(m, src)
}
...
func (m *CreateIngressGatewayRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreateIngressGatewayRequest.Merge(m, src)
}
...
func (m *UpdateIngressGatewayRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateIngressGatewayRequest.Merge(m, src)
}
...
func (m *DeleteIngressGatewayRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeleteIngressGatewayRequest.Merge(m, src)
}
