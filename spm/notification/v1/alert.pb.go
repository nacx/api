...
func (m *UpdateAlertRequest) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *DeleteAlertRequest) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *GetAlertRequest) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
var fileDescriptor_3b11b2fb4e5b6d61 = []byte{
	...
	,
}
