...
func request_WebhookService_SendAlert_0(ctx context.Context, marshaler runtime.Marshaler, client WebhookServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AlertMessageRequest
	...
	msg, err := client.SendAlert(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func RegisterWebhookServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client WebhookServiceClient) error {
	...
	mux.Handle("POST", pattern_WebhookService_SendAlert_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_WebhookService_SendAlert_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_WebhookService_SendAlert_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_WebhookService_SendAlert_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "webhook", "alert"}, ""))
)

var (
	forward_WebhookService_SendAlert_0 = runtime.ForwardResponseMessage
)
