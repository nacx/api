...
type Notification struct {
	...
	Condition NotificationCondition `protobuf:"varint,1,opt,name=condition,proto3,enum=tetrate.api.tcc.spm.alert.v1.NotificationCondition" json:"condition,omitempty"`
...
func (*Rule_Service) Descriptor() ([]byte, []int) {
	return fileDescriptor_6c7cab62fa432213, []int{3, 0}
}
...
func (*Rule_AlertThreshold) Descriptor() ([]byte, []int) {
	return fileDescriptor_6c7cab62fa432213, []int{3, 1}
}
...
func init() {
	proto.RegisterEnum("tetrate.api.tcc.spm.alert.v1.NotificationCondition", NotificationCondition_name, NotificationCondition_value)
	...
	proto.RegisterType((*Notification)(nil), "tetrate.api.tcc.spm.alert.v1.Notification")
...
var fileDescriptor_6c7cab62fa432213 = []byte{
	...
	,
}
