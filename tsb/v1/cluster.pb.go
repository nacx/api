...
type Service struct {
	...
	NumKubernetesEndpoints uint32 `protobuf:"varint,5,opt,name=num_kubernetes_endpoints,json=numKubernetesEndpoints,proto3" json:"num_kubernetes_endpoints,omitempty"`
	// The number of VMs providing this service.
	NumVmEndpoints       uint32   `protobuf:"varint,6,opt,name=num_vm_endpoints,json=numVmEndpoints,proto3" json:"num_vm_endpoints,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Service) GetNumKubernetesEndpoints() uint32 {
	if m != nil {
		return m.NumKubernetesEndpoints
	}
	return 0
}

func (m *Service) GetNumVmEndpoints() uint32 {
	if m != nil {
		return m.NumVmEndpoints
	}
	return 0
}
...
var fileDescriptor_9d247cfba6d5104d = []byte{
	...
	,
}
...
func (m *Service) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.NumVmEndpoints != 0 {
		i = encodeVarintCluster(dAtA, i, uint64(m.NumVmEndpoints))
		i--
		dAtA[i] = 0x30
	}
	if m.NumKubernetesEndpoints != 0 {
		i = encodeVarintCluster(dAtA, i, uint64(m.NumKubernetesEndpoints))
		i--
		dAtA[i] = 0x28
	}
...
func (m *Service) Size() (n int) {
	...
	if m.NumKubernetesEndpoints != 0 {
		n += 1 + sovCluster(uint64(m.NumKubernetesEndpoints))
	}
	if m.NumVmEndpoints != 0 {
		n += 1 + sovCluster(uint64(m.NumVmEndpoints))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Service) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NumKubernetesEndpoints", wireType)
			}
			m.NumKubernetesEndpoints = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowCluster
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NumKubernetesEndpoints |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NumVmEndpoints", wireType)
			}
			m.NumVmEndpoints = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NumVmEndpoints |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
