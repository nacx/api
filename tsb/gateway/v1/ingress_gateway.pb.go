...
func (ServerTLSSettings_TLSMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{12, 0}
}
...
func (*IngressGateway) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{0}
}
...
func (*HttpServer) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{1}
}
...
func (*HttpRouting) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{2}
}
...
func (*HttpRouting_HTTPCookie) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{2, 0}
}
...
func (*HttpRouting_StickySession) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{2, 1}
}
...
func (*HttpRouting_StickySession) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _HttpRouting_StickySession_OneofMarshaler, _HttpRouting_StickySession_OneofUnmarshaler, _HttpRouting_StickySession_OneofSizer, []interface{}{
...
func _HttpRouting_StickySession_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*HttpRouting_StickySession)
	// hash_key
	...
	case nil:
	default:
		return fmt.Errorf("HttpRouting_StickySession.HashKey has unexpected type %T", x)
	}
	return nil
}

func _HttpRouting_StickySession_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*HttpRouting_StickySession)
	switch tag {
	case 1: // hash_key.header
		...
		m.HashKey = &HttpRouting_StickySession_Header{x}
		return true, err
	case 2: // hash_key.cookie
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(HttpRouting_HTTPCookie)
		err := b.DecodeMessage(msg)
		m.HashKey = &HttpRouting_StickySession_Cookie{msg}
		return true, err
	case 3: // hash_key.use_source_ip
		...
		m.HashKey = &HttpRouting_StickySession_UseSourceIp{x != 0}
		return true, err
	default:
		return false, nil
	}
...
func _HttpRouting_StickySession_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*HttpRouting_StickySession)
	// hash_key
	switch x := m.HashKey.(type) {
	case *HttpRouting_StickySession_Header:
...
func (*HttpRule) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{3}
}
...
func _HttpRule_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*HttpRule)
	switch tag {
	case 3: // route_or_redirect.route
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Route)
		...
		return true, err
	case 4: // route_or_redirect.redirect
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Redirect)
...
func (*HttpMatchCondition) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{4}
}
...
func (*StringMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{5}
}
...
func (*HTTPRewrite) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{6}
}
...
func (*Headers) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{7}
}
...
func (*Headers_HeaderOperations) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{7, 0}
}
...
func (*HttpModifyAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{8}
}
...
func (*Route) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{9}
}
...
func (*Redirect) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{10}
}
...
func (*CorsPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{11}
}
...
type ServerTLSSettings struct {
	...
	// respectively.
	Mode ServerTLSSettings_TLSMode `protobuf:"varint,1,opt,name=mode,proto3,enum=tetrate.api.tsb.gateway.v1.ServerTLSSettings_TLSMode" json:"mode,omitempty"`
...
func (*ServerTLSSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{12}
}
...
func (*Authentication) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{13}
}
...
func _Authentication_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case nil:
	default:
		return fmt.Errorf("Authentication.Authn has unexpected type %T", x)
	}
	return nil
}
...
func _Authentication_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // authn.jwt
		...
		msg := new(Authentication_JWT)
		err := b.DecodeMessage(msg)
		m.Authn = &Authentication_Jwt{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*Authentication_JWT) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{13, 0}
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*Authentication_JWT) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Authentication_JWT_OneofMarshaler, _Authentication_JWT_OneofUnmarshaler, _Authentication_JWT_OneofSizer, []interface{}{
		(*Authentication_JWT_JwksUri)(nil),
		(*Authentication_JWT_Jwks)(nil),
	}
}

func _Authentication_JWT_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*Authentication_JWT)
	// keys
	...
	case nil:
	default:
		return fmt.Errorf("Authentication_JWT.Keys has unexpected type %T", x)
	}
	return nil
}

func _Authentication_JWT_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Authentication_JWT)
	switch tag {
	case 3: // keys.jwks_uri
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Keys = &Authentication_JWT_JwksUri{x}
		return true, err
	case 4: // keys.jwks
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		x, err := b.DecodeStringBytes()
		m.Keys = &Authentication_JWT_Jwks{x}
		return true, err
	default:
		return false, nil
	}
...
func _Authentication_JWT_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*Authentication_JWT)
	// keys
	switch x := m.Keys.(type) {
	case *Authentication_JWT_JwksUri:
...
func (*Authorization) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{14}
}
...
func (*Authorization) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Authorization_OneofMarshaler, _Authorization_OneofUnmarshaler, _Authorization_OneofSizer, []interface{}{
		(*Authorization_External)(nil),
		(*Authorization_Local)(nil),
	}
}

func _Authorization_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*Authorization)
	// authz
	switch x := m.Authz.(type) {
	...
	case nil:
	default:
		return fmt.Errorf("Authorization.Authz has unexpected type %T", x)
	}
	return nil
}

func _Authorization_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Authorization)
	switch tag {
	case 1: // authz.external
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Authorization_ExternalAuthzBackend)
		err := b.DecodeMessage(msg)
		m.Authz = &Authorization_External{msg}
		return true, err
	case 2: // authz.local
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Authorization_LocalAuthz)
		err := b.DecodeMessage(msg)
		m.Authz = &Authorization_Local{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Authorization_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*Authorization)
	// authz
	switch x := m.Authz.(type) {
	case *Authorization_External:
...
func (*Authorization_ExternalAuthzBackend) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{14, 0}
}
...
func (*Authorization_LocalAuthz) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{14, 1}
}
...
func (*LocalAuthzRule) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{15}
}
...
func (*LocalAuthzRule_HttpOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{15, 0}
}
...
func (*Subject) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{16}
}
...
func (*Subject_JWTClaims) Descriptor() ([]byte, []int) {
	return fileDescriptor_88a28bd1c1dae25d, []int{16, 0}
}
...
func init() {
	proto.RegisterEnum("tetrate.api.tsb.gateway.v1.ServerTLSSettings_TLSMode", ServerTLSSettings_TLSMode_name, ServerTLSSettings_TLSMode_value)
	proto.RegisterType((*IngressGateway)(nil), "tetrate.api.tsb.gateway.v1.IngressGateway")
	proto.RegisterType((*HttpServer)(nil), "tetrate.api.tsb.gateway.v1.HttpServer")
	proto.RegisterType((*HttpRouting)(nil), "tetrate.api.tsb.gateway.v1.HttpRouting")
	proto.RegisterType((*HttpRouting_HTTPCookie)(nil), "tetrate.api.tsb.gateway.v1.HttpRouting.HTTPCookie")
	proto.RegisterType((*HttpRouting_StickySession)(nil), "tetrate.api.tsb.gateway.v1.HttpRouting.StickySession")
	proto.RegisterType((*HttpRule)(nil), "tetrate.api.tsb.gateway.v1.HttpRule")
	proto.RegisterType((*HttpMatchCondition)(nil), "tetrate.api.tsb.gateway.v1.HttpMatchCondition")
	proto.RegisterMapType((map[string]*StringMatch)(nil), "tetrate.api.tsb.gateway.v1.HttpMatchCondition.HeadersEntry")
	proto.RegisterType((*StringMatch)(nil), "tetrate.api.tsb.gateway.v1.StringMatch")
	proto.RegisterType((*HTTPRewrite)(nil), "tetrate.api.tsb.gateway.v1.HTTPRewrite")
	proto.RegisterType((*Headers)(nil), "tetrate.api.tsb.gateway.v1.Headers")
	proto.RegisterType((*Headers_HeaderOperations)(nil), "tetrate.api.tsb.gateway.v1.Headers.HeaderOperations")
	proto.RegisterMapType((map[string]string)(nil), "tetrate.api.tsb.gateway.v1.Headers.HeaderOperations.AddEntry")
	proto.RegisterMapType((map[string]string)(nil), "tetrate.api.tsb.gateway.v1.Headers.HeaderOperations.SetEntry")
	proto.RegisterType((*HttpModifyAction)(nil), "tetrate.api.tsb.gateway.v1.HttpModifyAction")
	proto.RegisterType((*Route)(nil), "tetrate.api.tsb.gateway.v1.Route")
	proto.RegisterType((*Redirect)(nil), "tetrate.api.tsb.gateway.v1.Redirect")
	proto.RegisterType((*CorsPolicy)(nil), "tetrate.api.tsb.gateway.v1.CorsPolicy")
	proto.RegisterType((*ServerTLSSettings)(nil), "tetrate.api.tsb.gateway.v1.ServerTLSSettings")
	proto.RegisterType((*Authentication)(nil), "tetrate.api.tsb.gateway.v1.Authentication")
	proto.RegisterType((*Authentication_JWT)(nil), "tetrate.api.tsb.gateway.v1.Authentication.JWT")
	proto.RegisterType((*Authorization)(nil), "tetrate.api.tsb.gateway.v1.Authorization")
	proto.RegisterType((*Authorization_ExternalAuthzBackend)(nil), "tetrate.api.tsb.gateway.v1.Authorization.ExternalAuthzBackend")
	proto.RegisterType((*Authorization_LocalAuthz)(nil), "tetrate.api.tsb.gateway.v1.Authorization.LocalAuthz")
	proto.RegisterType((*LocalAuthzRule)(nil), "tetrate.api.tsb.gateway.v1.LocalAuthzRule")
	proto.RegisterType((*LocalAuthzRule_HttpOperation)(nil), "tetrate.api.tsb.gateway.v1.LocalAuthzRule.HttpOperation")
	proto.RegisterType((*Subject)(nil), "tetrate.api.tsb.gateway.v1.Subject")
	proto.RegisterType((*Subject_JWTClaims)(nil), "tetrate.api.tsb.gateway.v1.Subject.JWTClaims")
	proto.RegisterMapType((map[string]string)(nil), "tetrate.api.tsb.gateway.v1.Subject.JWTClaims.OtherEntry")
}

func init() { proto.RegisterFile("ingress_gateway.proto", fileDescriptor_88a28bd1c1dae25d) }

var fileDescriptor_88a28bd1c1dae25d = []byte{
	...
	,
}
